        ...
        <div class="container">
            <div class="container-fluid">
                <a class="navbar-brand" href="/">
                    <h4 class="semi-bold mb-0 text-white mt-3">KELMAS</h4>
                    {{-- <p class="italic mt-0 text-white">Keluhan Masyarakat</p> --}}
                </a>
    ...
    <div class="col-lg-6 col-10 col">
        <div class="content shadow">
            ...
            @if (Session::has('pesan_logout'))
                <div class="alert alert-success my-2">
                    {{ Session::get('pesan_logout') }} {{ Auth::guard('masyarakat')->user()->nama }} 
                </div>
            @endif
            ...
            <form class="form" action="{{ route('pekat.storeLapor') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <input type="text" value="{{ old('tgl_kejadian') }}" name="tgl_kejadian"
                        placeholder="Pilih Tanggal Kejadian" id="tgl_kejadian" class="form-control" onfocusin="(this.type='date')"
                ...
                <div class="form-group">
                    <div class="input-group mb-3">
                        <select name="id_kategori" class="custom-select" id="inputGroupSelect01" required>
                            <option value="" selected>Pilih Kategori Kejadian</option>
                            @foreach ($kategori as $k)
                                <option value="{{$k->id_kategori}}">{{ ($k->nama) ? $k->nama : '-' }}</option>
                            @endforeach
...
<div class="mt-5">
    <hr>
    <div class="text-center">
        <p class="italic text-secondary">© Copyright    2023 Adrian • All rights reserved</p>
    </div>
</div>
